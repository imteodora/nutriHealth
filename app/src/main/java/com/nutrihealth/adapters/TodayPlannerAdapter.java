...
public class TodayPlannerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        switch (holder.getItemViewType()) {
            ...
            case FOOTER_VIEW_TYPE:
                ...
                if (position == breakfastList.size() + 2)
                    footerViewHolder.addIconIv.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            if (listener != null)
                                listener.onAddProductButtonPrssed(TodayListFragment.MealsSection.BREAKFAST);
                        }
                    });
                if (position == breakfastList.size() + 2 + firstSnackList.size() + 2)
                    ...
                    footerViewHolder.addIconIv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (listener != null)
                                listener.onAddProductButtonPrssed(TodayListFragment.MealsSection.FIRST_SNACK);
                        }
                    });
                if (position == breakfastList.size() + 2 + firstSnackList.size() + 2 + lunchList.size() + 2)
                    ...
                    footerViewHolder.addIconIv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (listener != null)
                                listener.onAddProductButtonPrssed(TodayListFragment.MealsSection.LUNCH);
                        }
                    });
                if (position == breakfastList.size() + 2 + firstSnackList.size() + 2 + lunchList.size() + 2 + secondSnackList.size() + 2)
                    ...
                    footerViewHolder.addIconIv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (listener != null)
                                listener.onAddProductButtonPrssed(TodayListFragment.MealsSection.SECOND_SNACK);
                        }
                    });
                if (position == breakfastList.size() + 2 + firstSnackList.size() + 2 + lunchList.size() + 2 + secondSnackList.size() + 2 + dinnerList.size() + 2)
                    ...
                    footerViewHolder.addIconIv.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            if (listener != null)
                                listener.onAddProductButtonPrssed(TodayListFragment.MealsSection.DINNER);
                        }
                    });
